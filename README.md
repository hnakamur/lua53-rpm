...
A Dockerfile to build [Lua](https://www.lua.org/) 5.3.x RPM with prefix /opt/lua-5.3 for CentOS 6 and 7 using [Mock](https://fedoraproject.org/wiki/Mock) or [fedora copr](https://copr.fedoraproject.org/).
